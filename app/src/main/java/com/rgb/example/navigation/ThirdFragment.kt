...
import com.rgb.example.navigation.databinding.FragmentThirdBinding
...
class ThirdFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mPerson = Person(arguments?.getString("user_name", "") ?: "",
            arguments?.getString("user_email", "") ?: "")

        mBinding.person = mPerson
        mBinding.buttonTerms.setOnClickListener {
            findNavController().navigate(R.id.action_thirdFragment_to_termsFragment)
        }
